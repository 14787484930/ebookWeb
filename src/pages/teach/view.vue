  ...
  export default {
    ...
    computed: {
      ...
      isOrder: function () {  /* 添加人：zxl ，描述：判断是否显示接单按钮*/
        return !this.$store.getters.power_flag && this.teach.orderUser == null;
      },
      ...
      isRevoke: function () { /* 添加人：zxl ，描述：判断是否显示撤销按钮 */
        return !!(this.$store.getters.power && this.teach.orderUser != null && this.teach.isScore === 0);
      },
      isOrderScore: function () { /* 添加人：zxl ，描述：判断是否显示评价按钮 d*/
        return !!(this.$store.getters.power && this.teach.orderUser != null && this.teach.isScore === 0);
      }
    },
    methods: {
      ...
      isOrderSelf: function () {  /* 添加人：zxl ，描述：判断是否显示接单人按钮 */
        this.isOrderSelfFlag = !!(this.$store.getters.power_flag && this.teach.orderUser != null);
      },
      // 将富文本字符挂在到Dom文档中
      editorMounted: function (des) {
        ...
        const BaseExtend = Vue.extend(baseOptions);
